...
功能码04查询报文例:  
![功能码04查询报文例](./功能码04查询报文例.png)  
功能码04响应报文例:  
![功能码04响应报文例](./功能码04响应报文例.png)
**05（0x05）写单个线圈或单个离散输出**  
本功能码用于将单个线圈寄存器（或离散输入）设置为ON或OFF。该功能码支持广播模式，在广播模式下，所有从站设备的同一地址的值将被统一修改。查询报文中的ON/OFF状态由报文数据字段的常数指定，0xFF00表示ON状态，0x0000表示OFF状态。其他所有值均是非法的，并且对寄存器不起作用，将会返回异常响应。  
功能码05查询报文例：  
![功能码05查询报文例](./功能码05查询报文例.png)  
功能码05响应报文例:  
![功能码05响应报文例](./功能码05响应报文例.png)  
**06（0x06）写单个保持寄存器**  
本功能码用于更新从设备的单个保持寄存器的值。该功能码支持广播模式，在广播模式下，所有从设备的同一地址的值将被统一修改。  
功能码06查询报文例:  
![功能码06查询报文例](./功能码06查询报文例.png)    
功能码06响应报文例:  
![功能码06响应报文例](./功能码06响应报文例.png)    
